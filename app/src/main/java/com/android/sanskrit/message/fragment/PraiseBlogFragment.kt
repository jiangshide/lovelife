...
import kotlinx.android.synthetic.main.message_praise_fragment.messagePraiseRecycleView

/**
 * created by jiangshide on 2020/5/21.
 * email:18311271399@163.com
 */
class PraiseBlogFragment : MyFragment() {
  ...
  override fun onCreateView(
    ...
    return setTitleView(R.layout.message_praise_fragment)
  }
  ...
  override fun onViewCreated(
    ...
    blogVM!!.praiseBlog.observe(this, Observer {
      hiddle()
      cancelRefresh()
      clearAnimTab()
      if (it.error != null) {
  ...
  private fun request() {
    blogVM?.praiseBlog(context = mActivity)
    showLoading()
  }
  ...
  override fun onLoadMore(refreshLayout: RefreshLayout) {
    ...
    blogVM?.praiseBlog(isRefresh = false, context = mActivity)
  }
  ...
  private fun showView(data: MutableList<Blog>) {
    ...
    adapter = messagePraiseRecycleView.create(data, R.layout.home_find_fragment_item, {
      val blog = it
      it.setImg(
