 ...
 */
class TypeVRHolder(fragment: MyFragment,itemView: View,blogVM: BlogVM,
  lifecycleOwner: LifecycleOwner,
  adapter: BlogAdapter,zdRecycleView: ZdRecycleView,from: Int = FROM_FIND,private val uid:Long=-1
