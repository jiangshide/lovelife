...
public class ZdRouter {
    ...
    public void putActivity(String path, Class<? extends AppCompatActivity> clazz) {
    ...
    public Build go(String path, int requestCode) {
        Class<? extends AppCompatActivity> clazz = mActivitys.get(path);
...
//            ((Activity) mContext).startActivityForResult((Activity) mContext, intent, requestCode);
            ActivityCompat.startActivityForResult((AppCompatActivity) mContext, intent, requestCode, null);
        } else {
