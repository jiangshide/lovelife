...
import com.android.player.dplay.listener.PlayerEventListener;
import com.android.player.dplay.render.IRenderView;
import com.android.player.dplay.render.SurfaceRenderView;
...
public class VideoView<P extends AbstractPlayer> extends FrameLayout
        implements MediaPlayerControl, PlayerEventListener {
...
//        mPlayerContainer.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.bg));
