...
public final class AppUtil {
  ...
  public static void goUrl(String url) {
    ...
    AppUtil.getApplicationContext().startActivity(intent);
  }
  ...
  public static void goActivity(String activity, Bundle bundle) {
    ...
    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    intent.setClassName(AppUtil.getApplicationContext(), activity);
    AppUtil.getApplicationContext().startActivity(intent);
  }

  public static void goActivity(Class clazz) {
    goActivity(clazz, null);
  }

  public static void goActivity(Class clazz, Bundle bundle) {
    Intent intent = new Intent();
    if (bundle != null) {
      intent.putExtras(bundle);
    }
    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    intent.setClass(AppUtil.getApplicationContext(), clazz);
    AppUtil.getApplicationContext().startActivity(intent);
  }
  ...
  public static void installApp(final File file) {
    ...
    getApplicationContext().startActivity(getInstallAppIntent(file, true));
  }
  ...
  public static void uninstallApp(final String packageName) {
    ...
    getApplicationContext().startActivity(getUninstallAppIntent(packageName, true));
  }
  ...
  public static boolean isAppDebug() {
    return isAppDebug(getApplicationContext().getPackageName());
  }
  ...
  public static boolean isAppSystem() {
    return isAppSystem(getApplicationContext().getPackageName());
  }
  ...
  public static boolean isAppForeground() {
    ...
    for (ActivityManager.RunningAppProcessInfo aInfo : info) {
      if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
        return aInfo.processName.equals(getApplicationContext().getPackageName());
      }
    }
    return false;
  }
  ...
  public static void launchApp(final String packageName) {
    if (isSpace(packageName)) return;
    getApplicationContext().startActivity(getLaunchAppIntent(packageName, true));
  }
  ...
  public static void relaunchApp(final boolean isKillProcess) {
    PackageManager packageManager = getApplicationContext().getPackageManager();
    Intent intent =
        packageManager.getLaunchIntentForPackage(getApplicationContext().getPackageName());
  ...
  public static void launchAppDetailsSettings() {
    launchAppDetailsSettings(getApplicationContext().getPackageName());
  }
  ...
  public static Drawable getAppIcon() {
    return getAppIcon(getApplicationContext().getPackageName());
  }
  ...
  public static String getAppPath() {
    return getAppPath(getApplicationContext().getPackageName());
  }
  ...
  public static Signature[] getAppSignature() {
    return getAppSignature(getApplicationContext().getPackageName());
  }
  ...
  public static String getAppSignatureSHA1() {
    return getAppSignatureSHA1(getApplicationContext().getPackageName());
  }
  ...
  public static String getAppSignatureSHA256() {
    return getAppSignatureSHA256(getApplicationContext().getPackageName());
  }
  ...
  public static String getAppSignatureMD5() {
    return getAppSignatureMD5(getApplicationContext().getPackageName());
  }
  ...
  public static AppInfo getAppInfo() {
    return getAppInfo(getApplicationContext().getPackageName());
  }
  ...
  private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
      ...
      data = FileProvider.getUriForFile(getApplicationContext(), authority, file);
    }
    ...
    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
      ...
      try {// Access to usage information.
        ApplicationInfo info =
            pm.getApplicationInfo(getApplicationContext().getPackageName(), 0);
        AppOpsManager aom =
  ...
  public static ApplicationInfo getApplicationInfo(String path) {
    return getApplicationContext().getPackageManager()
        .getPackageArchiveInfo(path, PackageManager.GET_ACTIVITIES
            | PackageManager.GET_SERVICES
            | PackageManager.GET_CONFIGURATIONS
            | PackageManager.GET_INTENT_FILTERS).applicationInfo;
  }

  public static ActivityInfo[] getActivityInfos(String path) {
    return getApplicationContext().getPackageManager()
        .getPackageArchiveInfo(path, PackageManager.GET_ACTIVITIES).activities;
  }

  public static List<AppCompatActivity> getActivitiesByApplication(Context context) {
  ...
  public static boolean copy2Clipboard(String content) {
  ...
  public static KeyguardManager keyguardManager() {
    return (KeyguardManager) getApplicationContext().getSystemService(Context.KEYGUARD_SERVICE);
  }
  ...
  public static void showSystemPictureSelect(Object object, Uri path) {
    if (object == null || path == null) return;
    List cameraIntents = new ArrayList<Intent>();
    Intent captureIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
    PackageManager packageManager = AppUtil.getApplicationContext().getPackageManager();
    ...
    try {
      if (object instanceof AppCompatActivity) {
        ((AppCompatActivity) object).startActivityForResult(chooserIntent, REQUEST_CODE_IMAGE);
      } else if (object instanceof Fragment) {
        ((Fragment) object).startActivityForResult(chooserIntent, REQUEST_CODE_IMAGE);
      }
  ...
  public static File cropUri(Object object, Uri uri) {
    return cropUri(object, uri, 160, 160, new File(AppUtil.getApplicationContext().getCacheDir()
        + "/"
        + System.currentTimeMillis()
        + ".jpeg"));
  }

  public static File cropUri(Object object, Uri uri, File file) {
    return cropUri(object, uri, 160, 160, file);
  }

  /**
   * 调用系统中自带的图片剪裁
   */
  public static File cropUri(Object object, Uri uri, int width, int height, File file) {
    ...
    try {
      if (object instanceof AppCompatActivity) {
        ((AppCompatActivity) object).startActivityForResult(intent, REQUEST_CROP);
      } else if (object instanceof Fragment) {
        ((Fragment) object).startActivityForResult(intent, REQUEST_CROP);
      }
    } catch (ActivityNotFoundException e) {
      LogUtil.e(e);
    }
