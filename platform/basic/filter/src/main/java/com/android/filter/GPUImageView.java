...
import com.android.filter.filter.GPUImageFilter;
import com.android.filter.util.Rotation;
...
import static com.android.filter.GPUImage.SURFACE_TYPE_SURFACE_VIEW;
import static com.android.filter.GPUImage.SURFACE_TYPE_TEXTURE_VIEW;
...
public class GPUImageView extends FrameLayout {
     ...
     *
     * @param path the uri of the new image
     */
    public void setImage(final String path) {
        gpuImage.setImage(Uri.parse(path));
    }
