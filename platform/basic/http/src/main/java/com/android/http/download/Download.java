...
/**
 * created by jiangshide on 2016-08-17.
...
public class Download {
    ...
    public static String DOWN_FAIL="downFail";
                ...
                switch (msg.what) {
                    case -1:
                      Exception exception = (Exception) msg.obj;
                        ...
                        ZdEvent.Companion.get().with(DOWN_FAIL).post(exception);
                        break;
                    case 1:
                      int progress = msg.arg1;
                        listener.onDownloading(progress);
                      ZdEvent.Companion.get().with(DOWNING).post(progress);
                        break;
                    case 2:
                      File file = (File) msg.obj;
                        listener.onDownloadSuccess(file);
                        ZdEvent.Companion.get().with(DOWN_SUCCESS).post(file);
                        break;
                }
            }
        }
