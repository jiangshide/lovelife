...
public class WarmFilter extends BaseFilter{
	...
	public void createProgram() {
		...
		mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(mProgram, "layerImage");
		mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(mProgram, "greyFrame");
        ...
        .wrap(arrayOfByte));
		mMaskGrey1TextureId = OpenGlUtils.loadTexture(c, "filter/warm_layer1.jpg");
		mMaskGrey2TextureId = OpenGlUtils.loadTexture(c, "filter/bluevintage_mask1.jpg");
