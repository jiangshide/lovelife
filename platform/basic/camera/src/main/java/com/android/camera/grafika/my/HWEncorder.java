package com.android.camera.grafika.my;
...
public class HWEncorder {
    ...
    public void init(int width, int height, int colorFormat, int bitRate, int sampleRate,
        ...
        MediaFormat
            audioFormat = MediaFormat.createAudioFormat(HWCodec.MIME_TYPE_AAC, sampleRate, channels);
    ...
    private void drainEncoder(MediaCodec encoder, MediaCodec.BufferInfo bufferInfo) throws
        Exception {
