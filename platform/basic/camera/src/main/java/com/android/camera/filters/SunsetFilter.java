...
public class SunsetFilter extends BaseFilter{
	...
	public void createProgram() {
		...
		GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, 256, 2, 0, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, ByteBuffer
        .wrap(arrayOfByte));
		mMaskGrey1TextureId = OpenGlUtils.loadTexture(c, "filter/rise_mask1.jpg");
		mMaskGrey2TextureId = OpenGlUtils.loadTexture(c, "filter/rise_mask2.jpg");
