...
public class SunriseFilter extends BaseFilter{
	...
	public SunriseFilter(Context c) {
		super(c);
	}
	...
	public void createProgram() {
		...
		mMaskGrey3UniformLocation = GLES20.glGetUniformLocation(mProgram, "grey3Frame");
		...
		mMaskGrey1TextureId = OpenGlUtils.loadTexture(c, "filter/amaro_mask1.jpg");
		GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
		mMaskGrey2TextureId = OpenGlUtils.loadTexture(c, "filter/amaro_mask2.jpg");
		GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
		mMaskGrey3TextureId = OpenGlUtils.loadTexture(c, "filter/toy_mask1.jpg");
