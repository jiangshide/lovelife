...
public class VideoEncoderCore {
    ...
    public VideoEncoderCore(int width, int height, int bitRate, File outputFile)
        ...
        if (VERBOSE) LogUtil.d( "format: " + format);
     ...
     */
    public void release() {
        if (VERBOSE) LogUtil.d( "releasing encoder objects");
        if (mEncoder != null) {
            mEncoder.stop();
            mEncoder.release();
            mEncoder = null;
    ...
    public void drainEncoder(boolean endOfStream) {
        ...
        if (VERBOSE) LogUtil.d( "drainEncoder(" + endOfStream + ")");
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                LogUtil.d("encoder output format changed: " + newFormat);
                ...
                if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
                    ...
                    if (VERBOSE) LogUtil.d( "ignoring BUFFER_FLAG_CODEC_CONFIG");
                    mBufferInfo.size = 0;
                }
