...
public class ZdLocation {
    ...
    private static class LocationHolder {
        private static ZdLocation instance = new ZdLocation();
    }

    public static ZdLocation getInstance() {
    ...
    public ZdLocation setAmapListener(IAmapListener listener) {
    ...
    public ZdLocation getCity(Context context, IPoiSearchListener iPoiSearchListener) {
        // 先获取定位
