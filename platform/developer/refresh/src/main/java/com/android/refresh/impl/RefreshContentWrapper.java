...
import com.android.refresh.util.DesignUtil;
import java.util.LinkedList;
import java.util.List;
import java.util.Queue;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static com.android.refresh.util.SmartUtil.canScrollVertically;
import static com.android.refresh.util.SmartUtil.isContentView;
import static com.android.refresh.util.SmartUtil.isTransformedTouchPointInView;
import static com.android.refresh.util.SmartUtil.measureViewHeight;
import static com.android.refresh.util.SmartUtil.scrollListBy;
