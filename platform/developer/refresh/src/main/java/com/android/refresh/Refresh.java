...
import com.android.refresh.api.DefaultRefreshFooterCreator;
import com.android.refresh.api.DefaultRefreshHeaderCreator;
import com.android.refresh.api.DefaultRefreshInitializer;
import com.android.refresh.api.RefreshContent;
import com.android.refresh.api.RefreshFooter;
import com.android.refresh.api.RefreshHeader;
import com.android.refresh.api.RefreshInternal;
import com.android.refresh.api.RefreshKernel;
import com.android.refresh.api.RefreshLayout;
import com.android.refresh.api.ScrollBoundaryDecider;
import com.android.refresh.constant.DimensionStatus;
import com.android.refresh.constant.RefreshState;
import com.android.refresh.constant.SpinnerStyle;
import com.android.refresh.footer.BallPulseFooter;
import com.android.refresh.header.BezierRadarHeader;
import com.android.refresh.impl.RefreshContentWrapper;
import com.android.refresh.impl.RefreshFooterWrapper;
import com.android.refresh.impl.RefreshHeaderWrapper;
import com.android.refresh.listener.OnLoadMoreListener;
import com.android.refresh.listener.OnMultiPurposeListener;
import com.android.refresh.listener.OnRefreshListener;
import com.android.refresh.listener.OnRefreshLoadMoreListener;
import com.android.refresh.listener.OnStateChangedListener;
...
import static com.android.refresh.util.SmartUtil.dp2px;
import static com.android.refresh.util.SmartUtil.fling;
import static com.android.refresh.util.SmartUtil.isContentView;
...
public class Refresh extends ViewGroup implements RefreshLayout, NestedScrollingParent{
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    if(notify) {
                        mRefreshListener.onRefresh(Refresh.this);
                    }
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(
                        Refresh.this, mHeaderHeight,  (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    if (notify) {
                        mOnMultiPurposeListener.onRefresh(Refresh.this);
                    }
    ...
    protected void moveSpinnerInfinitely(float spinner) {
        ...
        if (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableRefreshOrLoadMore(mEnableLoadMore) && spinner < 0
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    if (mLoadMoreListener != null) {
                        mLoadMoreListener.onLoadMore(Refresh.this);
                    } else if (mOnMultiPurposeListener == null) {
                        finishLoadMore(2000);//如果没有任何加载监听器，两秒之后自动关闭
                    }
                    final OnLoadMoreListener listener = mOnMultiPurposeListener;
                    if (listener != null) {
                        listener.onLoadMore(Refresh.this);
                    }
                }
            }, mReboundDuration);
        }
     ...
     * Recommended {@link com.android.refresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.android.refresh.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.android.refresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.android.refresh.impl.ScrollBoundaryDeciderAdapter}
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (count == 0) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(Refresh.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            if (mIsBeingDragged) {
                                ...
                                mTouchSpinner = 0;
                                mIsBeingDragged = false;
                                Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                                Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
                            }
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                                Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_UP, mLastTouchX, mLastTouchY, 0));
                                mNestedInProgress = false;
                                mTouchSpinner = 0;
                            }
                        }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (count == 0) {
                    ...
                    final int startDelay = mRefreshFooter.onFinish(Refresh.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            if (mIsBeingDragged) {
                                ...
                                Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offsetY + mTouchSlop * 2, 0));
                                Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offsetY, 0));
                            }
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                                Refresh.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_UP, mLastTouchX, mLastTouchY, 0));
        ...
        if (mState == RefreshState.None && isEnableRefreshOrLoadMore(mEnableRefresh)) {
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    final View thisView = Refresh.this;
                    mLastTouchX = thisView.getMeasuredWidth() / 2f;
                    mKernel.setState(RefreshState.PullDownToRefresh);
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return Refresh.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
        //</editor-fold>
    ...
    public Refresh setOnTouchListener(OnTouchEventListener listener) {
