 ...
 */
public class ZdCircleImg extends ZdImageView {
  ...
  public ZdCircleImg(Context context) {
    super(context);

    init();
  }

  public ZdCircleImg(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public ZdCircleImg(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);

    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ZdCircleImageView, defStyle, 0);

    mBorderWidth =
        a.getDimensionPixelSize(R.styleable.ZdCircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
    mBorderColor = a.getColor(R.styleable.ZdCircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
    mBorderOverlay =
        a.getBoolean(R.styleable.ZdCircleImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
    mCircleBackgroundColor = a.getColor(R.styleable.ZdCircleImageView_civ_circle_background_color,
