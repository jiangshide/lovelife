 ...
 */
public class ZdAutoScroll extends ScrollView {
  ...
  private int fistTimeScroll = 2000;//多少秒后开始滚动，默认5秒
  private int scrollRate = 50;//多少毫秒滚动一个像素点


  public ZdAutoScroll(Context context) {
    this(context, null);
  }

  public ZdAutoScroll(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public ZdAutoScroll(Context context, AttributeSet attrs, int defStyleAttr) {
    this(context, attrs, defStyleAttr, 0);
  }

  @SuppressLint("NewApi")
  public ZdAutoScroll(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  @Override protected void dispatchVisibilityChanged(View changedView, int visibility) {
    ...
    //LogUtil.e("-----------jsd~changedView:",changedView," | visibility:",visibility);
  }
