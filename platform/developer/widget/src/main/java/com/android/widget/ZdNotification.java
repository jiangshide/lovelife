...
public class ZdNotification {
  ...
  private int defaultNotificationId = 1;//默认通知Id
  ...
  public NotificationManager build() {
    ...
    if (mService != null) {
      mService.startForeground(mNotificationId > 0 ? mNotificationId : defaultNotificationId,
          notification);
    }
...
//        : Notification.FLAG_NO_CLEAR | Notification.FLAG_SHOW_LIGHTS;
    ...
    notificationManager.notify(mNotificationId > 0 ? mNotificationId : defaultNotificationId,
        notification);
  ...
  public ZdNotification setPriority(int priority){
  ...
  public ZdNotification setClass(String action, Bundle bundle, Class clazz) {
    ...
    intent.putExtra(NOTIFICATION, mNotificationId > 0 ? mNotificationId : defaultNotificationId);
    if (bundle != null) {
  ...
  public ZdNotification setId(int notificationId) {
  ...
  public ZdNotification setLargeIcon(int icon) {
