 ...
 */
  ...
  public static ZdDialog createView(Context context,int style, int layout, DialogViewListener l) {
    cancelDialog();
    return mZdDialog = new ZdDialog(context,style, layout, l);
  }
  ...
  public static ZdDialog cancelDialog() {
    if (null != mZdDialog) {
      mZdDialog.dismiss();
      mZdDialog = null;
    }
  ...
  public ZdDialog setCancelListener(OnCancelListener listener) {
