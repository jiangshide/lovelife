 ...
 */
public class ZdBSwitch extends View implements Checkable {
  /**
   * static state
   */
  ...
  public ZdBSwitch(Context context) {
    super(context);
    init(context, null);
  }

  public ZdBSwitch(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public ZdBSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init(context, attrs);
  }

  @TargetApi(Build.VERSION_CODES.LOLLIPOP)
  public ZdBSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  public interface OnCheckedChangeListener {
    void onCheckedChanged(ZdBSwitch view, boolean isChecked);
  }
