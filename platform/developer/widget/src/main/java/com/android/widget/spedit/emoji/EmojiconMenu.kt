...
import com.android.widget.spedit.emoji.EmojiManager.OnUnzipSuccessListener
import com.android.widget.spedit.emoji.EmojiconPagerView.EaseEmojiconPagerViewListener
import com.android.widget.spedit.emoji.EmojiconScrollTabBar.EaseScrollTabBarItemClickListener
import kotlinx.android.synthetic.main.common_emoj_widget_emojicon.view.indicator_view
import kotlinx.android.synthetic.main.common_emoj_widget_emojicon.view.pager_view
import kotlinx.android.synthetic.main.common_emoj_widget_emojicon.view.tab_bar
import java.util.*
...
class EmojiconMenu : EmojiconMenuBase {
    ...
    private fun initDefault(defaultGifEmojis: List<DefaultGifEmoji>) {
        ...
        emojiconGroupList.add(
            EmojiconGroupEntity(R.drawable.common_emoj_smile,
                defaultGifEmojis)
        )
