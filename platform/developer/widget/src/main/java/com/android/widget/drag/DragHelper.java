package com.android.widget.drag;
...
public class DragHelper {
  ...
  public static DragHelper create(ViewGroup forParent, Callback cb) {
    return new DragHelper(forParent.getContext(), forParent, null, cb);
  }
   ...
   * @return a new ViewDragHelper instance
   */
  public static DragHelper create(ViewGroup forParent, Interpolator interpolator, Callback cb) {
    return new DragHelper(forParent.getContext(), forParent, interpolator, cb);
  }
   ...
   * @return a new ViewDragHelper instance
   */
  public static DragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
   ...
   * @return a new ViewDragHelper instance
   */
  public static DragHelper create(
      ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
    final DragHelper helper = create(forParent, interpolator, cb);
    helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
    return helper;
  }
   ...
   * @param interpolator interpolator for scroller
   */
  private DragHelper(Context context, ViewGroup forParent, Interpolator interpolator, Callback cb) {
    if (forParent == null) {
