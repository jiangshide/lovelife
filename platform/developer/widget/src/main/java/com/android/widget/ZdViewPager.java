...
public class ZdViewPager extends ViewPager implements ViewPager.PageTransformer {
    ...
    public ZdViewPager setFragments(List<Fragment> fragments){
    ...
    public ZdViewPager setTitles(List<String> titles){
      if(mZdFragmentPagerAdapter != null){
    ...
    public ZdViewPager setPageListener(ViewPager.OnPageChangeListener listener){
        if(mZdFragmentPagerAdapter != null){
    ...
    public ZdViewPager initTabs(Context context, ZdTabLayout cusTabLayout,
    ...
    public ZdViewPager setListener(ZdPagerAdapter.OnPagerItemClickListener listener) {
