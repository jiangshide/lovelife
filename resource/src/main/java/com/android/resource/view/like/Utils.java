...
public class Utils {
  ...
  public static List<Icon> getIcons() {
    ...
    icons.add(new Icon(R.mipmap.liked, R.mipmap.unlike_write, IconType.Heart));
    icons.add(new Icon(R.mipmap.liked, R.mipmap.unlike_write, IconType.Star));
    icons.add(new Icon(R.mipmap.liked, R.mipmap.unlike_write, IconType.Thumb));
