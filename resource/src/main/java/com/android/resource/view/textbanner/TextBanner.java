...
public class TextBanner extends FrameLayout {
    ...
    public TextBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray
                a = context.obtainStyledAttributes(attrs, R.styleable.TextBanner, defStyleAttr, 0);
            mDuration = a.getInteger(R.styleable.TextBanner_durations, mDuration);
            mDelayTime = a.getInteger(R.styleable.TextBanner_delayTimes, mDelayTime);
            int animInResId = a.getResourceId(R.styleable.TextBanner_animIns, R.anim.com_haowen_textbanner_view_anim_in);
            int animOutResId = a.getResourceId(R.styleable.TextBanner_animOuts, R.anim.com_haowen_textbanner_view_anim_out);
            a.recycle();
            // 获取动画
